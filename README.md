...
- SECONDARY - флаг, сигнализирующий, что данный тест должен запускаться из SRAM памяти (т.е. являться вторичным загрузчиком). _ПОКА НЕ ОБРАБАТЫВАЕТСЯ, БУДЕТ РЕАЛИЗОВАН В ДАЛЬНЕЙШЕМ_
