...
Первичный загрузчик поддерживает последовательное исполнение кода из нескольких источников, в случае если после исполнения кода вторичного загрузчика был произведен возврат в код ROM с соответсющем кодом завершения.
...
EBADDATACRC           | 6          | Ошибка при проверки контрольной суммы данных
