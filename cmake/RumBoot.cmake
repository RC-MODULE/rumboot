...
set(RUMBOOT_MULVALUE_ARGS OBJCOPY_FLAGS FILES IRUN_FLAGS CFLAGS ASFLAGS CXXFLAGS TESTGROUP LDFLAGS PREPCMD CHECKCMD FEATURES TIMEOUT LOAD DEPENDS PACKIMAGE_FLAGS DUMPFLAGS)
...
function(add_rumboot_target)
  ...
  target_compile_options(${product} PUBLIC
    $<$<COMPILE_LANGUAGE:C>:${TARGET_CFLAGS} ${TARGET_OPTIMIZE} -DRUMBOOT_PRODUCT_NAME=\"${product}\">
    $<$<COMPILE_LANGUAGE:CXX>:${TARGET_CXXFLAGS} ${TARGET_OPTIMIZE} -DRUMBOOT_PRODUCT_NAME=\"${product}\">
    $<$<COMPILE_LANGUAGE:ASM>:-x assembler-with-cpp ${TARGET_ASFLAGS} ${TARGET_OPTIMIZE} -DRUMBOOT_PRODUCT_NAME=\"${product}\">
  )
