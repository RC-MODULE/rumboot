...
file(GLOB PLATFORM_SOURCES
    ...
    ${CMAKE_SOURCE_DIR}/src/platform/${RUMBOOT_PLATFORM}/lib/drivers/spi.c
...
if (NOT RUMBOOT_BUILD_TYPE STREQUAL "Debug")
    ...
    add_rumboot_target(
      ...
      CFLAGS -DGSPI_BASE=GSPI0_BASE -DGSPI_INT=GSPI0_INT -DGSPI_CHECK_REGS -Dspi_irq_test
      PREFIX gspi0
    )
    add_rumboot_target(
      CONFIGURATION IRAM
      FILES test_oi10_spi.c
      CFLAGS -DGSPI_BASE=GSPI1_BASE -DGSPI_INT=GSPI1_INT -DGSPI_CHECK_REGS -Dspi_irq_test
      PREFIX gspi1
    ) 
