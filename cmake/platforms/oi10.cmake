...
if (NOT RUMBOOT_BUILD_TYPE STREQUAL "Debug")
    ...
    add_rumboot_target(
      ...
      CFLAGS -DGSPI_BASE=GSPI_0_BASE -DGPIO1_X=0x1 -DGSPI_INT=GSPI0_INT -DGSPI_CHECK_REGS
    ...
    add_rumboot_target(
      CONFIGURATION IRAM
      FILES test_oi10_spi.c
      CFLAGS -DGSPI_BASE=GSPI_1_BASE -DGPIO1_X=0x2 -DGSPI_INT=GSPI1_INT -DGSPI_CHECK_REGS
      IRUN_FLAGS +spi_irq_test
      PREFIX gspi1
    ) 
