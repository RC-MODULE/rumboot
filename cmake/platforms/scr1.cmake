...
macro(RUMBOOT_PLATFORM_ADD_COMPONENTS)
    ...
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op0_relu_int32 main_relu_op0_int32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_relu_int32 main_relu_op1_int32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op0_relu_fp32  main_relu_op0_fp32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_relu_fp32  main_relu_op1_fp32)
    ...
    ADD_VPE_COUPLED_TEST_LOOP(vpe_norm_rnd_op0 main_norm_rnd_op0)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_norm_rnd_op1 main_norm_rnd_op1)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_norm_op2 main_norm_op2)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_norm_rnd_op2 main_norm_rnd_op2)
 ...
 ADD_VPE_COUPLED_TEST_LOOP(vpe_op0_alu_int8_low main_vpe_op0_alu_int8_low)
    ...
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op0_alu_int16_middle main_vpe_op0_alu_int16_middle)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op0_alu_int16_high main_vpe_op0_alu_int16_high)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op0_alu_fp32 main_vpe_op0_alu_fp32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_alu_int8_low main_vpe_op1_alu_int8_low)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_alu_int8_middle main_vpe_op1_alu_int8_middle)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_alu_int8_high main_vpe_op1_alu_int8_high)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_alu_int16_low main_vpe_op1_alu_int16_low)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_alu_int16_middle main_vpe_op1_alu_int16_middle)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_alu_int16_high main_vpe_op1_alu_int16_high)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op1_alu_fp32 main_vpe_op1_alu_fp32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op2_alu_int8_low main_vpe_op2_alu_int8_low)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op2_alu_int8_high main_vpe_op2_alu_int8_high)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op2_alu_int16_low main_vpe_op2_alu_int16_low)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op2_alu_int16_high main_vpe_op2_alu_int16_high)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_op2_alu_fp32 main_vpe_op2_alu_fp32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_mul_op0_int32 main_vpe_mul_op0_int32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_mul_op0_int8 main_vpe_mul_op0_int8)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_mul_op0_fp32 main_vpe_mul_op0_fp32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_mul_op1_int32 main_vpe_mul_op1_int32)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_mul_op1_int8 main_vpe_mul_op1_int8)
    ADD_VPE_COUPLED_TEST_LOOP(vpe_mul_op1_fp32 main_vpe_mul_op1_fp32)
    ...
    ADD_VPE_COUPLED_TEST_LOOP(vpe_together_op012 main_together_op012) # VPE_25
