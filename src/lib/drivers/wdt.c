...
/*void wdt_init(int to_ctrl, int interval)
{
...
/*void write_to_crg_ddr_fbdiv(int value)
{
...
/*bool check_crg_ddr_fbdiv_default()
{
                 ...
                 int crg_wr_lock) 
{
  ...
  if (*magic_var == wdt_magic)
  {
      ...
      bool flag = check_crg_ddr_fbdiv_default(crg_ddr_base, crg_fbdiv, crg_ddr_fbdiv_def);
  ...
  //WDT init
  wdt_init(wdt_interval, wdt_unlock_code, wdt_base, wdt_lock, wdt_ctrl, wdt_load);
  ...
  *magic_var = wdt_magic;
  ...
  //Unlock CRG_DDR
  unlock_crg_ddr(crg_unlock_code, crg_ddr_base, crg_wr_lock);
  //Write to CRG_DDR[FBDIV] wrong value
  write_to_crg_ddr_fbdiv(0xFFFFFFFF, crg_ddr_base, crg_fbdiv);
