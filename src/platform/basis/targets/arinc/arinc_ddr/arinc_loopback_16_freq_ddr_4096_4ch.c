...
int main()
{
	...
	uint32_t *tx_mem = rumboot_malloc_from_heap_aligned(heap_0, 70000, 4);
	uint32_t *rx_mem = rumboot_malloc_from_heap_aligned(heap_1,	70000, 4);	
