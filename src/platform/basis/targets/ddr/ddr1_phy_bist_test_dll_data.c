//-----------------------------------------------------------------------------
//  This program is for checking DDR1 Phy data groups DLLs
//  
//  Test includes:
//    - clear log space
//    - DDR1 initialisation with BIST parametes
//    - DDR1 BIST (part 9.13.1 in Phy documentation)
//    
...
//    
//    Warning! It looks like only first of tested groups of DDLs is used in test
//      Test doesnt switch to anther DDL when we ask him.
// 
