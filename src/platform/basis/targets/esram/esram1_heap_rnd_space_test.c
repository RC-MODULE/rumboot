...
//  Test includes:
//    - allocate some memory in ESRAM1
//    - cycle CHECK_AMOUNT
...
uint32_t memory_space_check ()
{
    ...
    volatile uint32_t *space_for_check = (uint32_t*) rumboot_malloc_from_heap_aligned (1, SPACE_SIZE, 4);
...
int main ()
{
    rumboot_printf("esram1_heap_rnd_space_test start\n");
