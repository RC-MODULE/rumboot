...
/*      !GPIO_test (GPIO1_BASE, GPIO2_BASE, 0x85, 0x2f, connection1, 0xff, 0xff, 0x33333333, 0x33333333, 0x85) &
      ...
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x80) &
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x08) &
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x40) &
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x04) &
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x20) &
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x02) &
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x10) &
      !GPIO_test (GPIO1_BASE, GPIO1_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x01) &
      
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x80) &
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x08) &
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x40) &
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x04) &
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x20) &
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x02) &
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0xf0, 0xf0, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x10) &
      !GPIO_test (GPIO2_BASE, GPIO2_BASE, 0x0f, 0x0f, connection, 0xff, 0xff, 0x33333333, 0x33333333, 0x01) 
     )
  {
