...
{
iowrite32(0,ARINC_BASE + INT_DIS);
irq_done=1;
...
//-------------------------------------
iowrite32(0x00000103,GPIO4_BASE + 0x2100); //TMR_EVENT(259 us)
//-----------------------------------------------
...
//-----------------------------------------------
iowrite32(0x0000ffff,ARINC_BASE + INT_LONG + 4*4); //INT_LAST
//-----------------------------------------------
iowrite32(0x0000ffff,ARINC_BASE + INT_TX); 
//----------------------------------------------------
iowrite32(0xffffffff,ARINC_BASE + INT_RX); 
//----------------------------------------------------
iowrite32(0xffffffff,ARINC_BASE + CHANNEL_EN); 
//----------------------------------------------------
iowrite32(0x0000ffff,ARINC_BASE + WAIT_TMR_TX); 
//-----------------------------------------------
iowrite32(0xffffffff,ARINC_BASE + WAIT_SIG_RX); 
//-----------------------------------------------
...
{ }
//-----------------------------------------------
iowrite32(0xffffffff,ARINC_BASE + SW_SIG_RX); 
//-----------------------------------------------
iowrite32(0x00000000,ARINC_BASE + WAIT_TMR_TX); 
//----------------------------------------------------
iowrite32(0x00000000,ARINC_BASE + WAIT_SIG_RX); 
//----------------------------------------------------
