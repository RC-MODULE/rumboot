...
//-----------------------------------------------------------------------------
//  This program is for measurement PCIe.DMA <-> DDR0 latency and bandwidth
...
#define data_mid ((uint32_t*) 0x80000000)
...
//    transaction address += 0x4000_0000 and transactions go to DDR0
//------------------------------------------------------------------------
void set_adt_slv ()
{
    ...
    iowrite32 (0x40000000      , ADDR_TRANS_SLV_BASE + ((2 * 3 + 3) << 2)) ;  //  translate address
