...
/////////////////////////////////////////////////////////////////////////////////////////
  iowrite32(0x00000077 , NPE_BASE+NA_MPE_BASE+0x00000104);
  ...
  iowrite32(0x0000007f , NPE_BASE+NA_MPE_BASE+0x0000011c);
  iowrite32(0x0000018f , NPE_BASE+NA_MPE_BASE+0x00000120);
  iowrite32(0x00000010 , NPE_BASE+NA_MPE_BASE+0x0000012c);
  iowrite32(0x00000000 , NPE_BASE+NA_MPE_BASE+0x00000130);
  iowrite32(0x00000000 , NPE_BASE+NA_MPE_BASE+0x0000013c);
  ...
  iowrite32(0x00000003 , NPE_BASE+NA_MPE_BASE+0x00000160);
  ...
  iowrite32(0x00000180 , NPE_BASE+NA_MPE_BASE+0x00000208);
  ...
  iowrite32(0x0000006f , NPE_BASE+NA_MPE_BASE+0x00000240);
  iowrite32(0x00000000 , NPE_BASE+NA_MPE_BASE+0x00000244);
  iowrite32(0x00009920 , NPE_BASE+NA_MPE_BASE+0x00000250);
  iowrite32(0x00000007 , NPE_BASE+NA_MPE_BASE+0x00000258);
  iowrite32(0x00000000 , NPE_BASE+NA_MPE_BASE+0x0000025c);
  iowrite32(0x00000000 , NPE_BASE+NA_MPE_BASE+0x00000260);
  iowrite32(0x00000000 , NPE_BASE+NA_MPE_BASE+0x00000264);
  iowrite32(0x00000070 , NPE_BASE+NA_MPE_BASE+0x00000270);
  iowrite32(0x0000000f , NPE_BASE+NA_MPE_BASE+0x00000278);
  iowrite32(0x00000000 , NPE_BASE+NA_MPE_BASE+0x0000027c);
  iowrite32(0x00000031 , NPE_BASE+NA_MPE_BASE+0x00000280);
  ...
  iowrite32(0x000015e0 , NPE_BASE+NA_MPE_BASE+0x000002d0);
  ...
  iowrite32(0x00000100 , NPE_BASE+NA_MPE_BASE+0x000002f0);
  iowrite32(0x00000003 , NPE_BASE+NA_MPE_BASE+0x000002f8);
  ...
  iowrite32(0x00000003 , NPE_BASE+NA_MPE_BASE+0x0000056c);
  ...
  iowrite32(0x00000003 , NPE_BASE+NA_MPE_BASE+0x000006f8);
  ...
  //iowrite32(0x00000007 , NPE_BASE+NA_MPE_BASE+MPE_MA_BASE+0x00000007*4);
  ...
  //iowrite32(0x0000007d , NPE_BASE+NA_MPE_BASE+MPE_MA_BASE+0x0000000e*4);
  ...
  iowrite32(0x00000190 , NPE_BASE+NA_MPE_BASE+MPE_MA_BASE+0x0000000f*4);
