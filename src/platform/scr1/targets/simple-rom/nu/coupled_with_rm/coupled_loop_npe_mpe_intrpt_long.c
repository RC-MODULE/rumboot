...
static volatile uint32_t  Int_MPE_FINISH;
static volatile uint32_t  VPE_IRQ = IRQ_VPE_CNTX_APPLY;

static volatile uint32_t  Int_CNTX_FINISH;
static volatile uint32_t  Int_CNTX_MARKED_FINISH;
...
static void handler1() {
	...
	rumboot_printf( "Int_irq= %x\n",(ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) )) ;
	    //MPE interrupts
		if (((ioread32((NPE_BASE + NA_CU_REGS_BASE)  + NA_INT_UNITS_STATUS) >> 10) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;
		iowrite32((1<<10),(NPE_BASE + NA_CU_REGS_BASE) + NA_INT_UNITS_RESET);		
		Int_VPE_CNTX_APPLY = 0;
		//Int_MPE_FINISH = 1;   ok!
		}		
		if (((ioread32((NPE_BASE + NA_CU_REGS_BASE)  + NA_INT_UNITS_STATUS) >> 9) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;
		iowrite32((1<<9),(NPE_BASE + NA_CU_REGS_BASE) + NA_INT_UNITS_RESET);		
		Int_VPE_CNTX_APPLY = 0;
		Int_MPE_FINISH = 1;
		}
	 if (((ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) >> 8) & 1)== 1)  {
		Int_VPE_CNTX_APPLY = 1;
		...
		if (((ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) >> 7) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;
		iowrite32((1<<7),(NPE_BASE + NA_CU_REGS_BASE) + NA_INT_UNITS_RESET);	
		Int_VPE_CNTX_APPLY = 0;
		}
  	  
		if (((ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) >> 6) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;
		iowrite32((1<<6),(NPE_BASE + NA_CU_REGS_BASE) + NA_INT_UNITS_RESET);
		Int_VPE_CNTX_APPLY = 0;
		}

		if (((ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) >> 5) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;		
		iowrite32((1<<5),(NPE_BASE + NA_CU_REGS_BASE) + NA_INT_UNITS_RESET);
		Int_VPE_CNTX_APPLY = 0;
		}

		if (((ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) >> 4) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;
		iowrite32((1<<4),(NPE_BASE + NA_CU_REGS_BASE) + NA_INT_UNITS_RESET);
		Int_VPE_CNTX_APPLY = 0;
		}
		...
		if (((ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) >> 3) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;	
		...
		if (((ioread32((NPE_BASE + NA_CU_REGS_BASE)  + NA_INT_UNITS_STATUS) >> 2) & 1) == 1) {
		Int_VPE_CNTX_APPLY = 1;
		iowrite32((1<<2),(NPE_BASE + NA_CU_REGS_BASE) + NA_INT_UNITS_RESET);
		Int_VPE_CNTX_APPLY = 0;
		}
	  
	if (((ioread32(NPE_BASE + NA_CU_REGS_BASE  + NA_INT_UNITS_STATUS) >> 1) & 1)== 1) {
		Int_VPE_CNTX_APPLY = 1;	
		...
		if (((ioread32((NPE_BASE + NA_CU_REGS_BASE)  + NA_INT_UNITS_STATUS) >> 0) & 1) == 1) {
		Int_VPE_CNTX_APPLY = 1;
...
//	nu_na_wait_int(NPE_BASE); //reset NA interrupts
 ...
 if( !wait_na_int_handled( 100, &Int_MPE_FINISH ) ) {
