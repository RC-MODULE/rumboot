...
{
    struct dma2plb6_setup_info dma_info, dma_info_1, dma_info_2, dma_info_3;
    ...
    dma_info_1.base_addr = DCR_DMAPLB6_BASE;
    dma_info_1.source_adr = source_phys;
    dma_info_1.dest_adr = dest_phys;
    dma_info_1.priority = priority_medium_low;
    dma_info_1.striding_info.striding = striding_none;
    dma_info_1.tc_int_enable = false;
    dma_info_1.err_int_enable = false;
    dma_info_1.int_mode = int_mode_level_wait_clr;
    dma_info_1.channel = channel1;

    dma_info_2.base_addr = DCR_DMAPLB6_BASE;
    dma_info_2.source_adr = source_phys;
    dma_info_2.dest_adr = dest_phys;
    dma_info_2.priority = priority_medium_low;
    dma_info_2.striding_info.striding = striding_none;
    dma_info_2.tc_int_enable = false;
    dma_info_2.err_int_enable = false;
    dma_info_2.int_mode = int_mode_level_wait_clr;
    dma_info_2.channel = channel2;    
    
    dma_info_3.base_addr = DCR_DMAPLB6_BASE;
    dma_info_3.source_adr = source_phys;
    dma_info_3.dest_adr = dest_phys;
    dma_info_3.priority = priority_medium_low;
    dma_info_3.striding_info.striding = striding_none;
    dma_info_3.tc_int_enable = false;
    dma_info_3.err_int_enable = false;
    dma_info_3.int_mode = int_mode_level_wait_clr;
    dma_info_3.channel = channel3;    
...
//    }
            dma_info.rw_transfer_size = rw_tr_size_8q;
            dma_info.transfer_width = tr_width_quadword;
            dma_info_1.rw_transfer_size = rw_tr_size_8q;
            dma_info_1.transfer_width = tr_width_quadword;
            dma_info_2.rw_transfer_size = rw_tr_size_8q;
            dma_info_2.transfer_width = tr_width_quadword;
            dma_info_3.rw_transfer_size = rw_tr_size_8q;
            dma_info_3.transfer_width = tr_width_quadword;
            ...
            dma_info.count = TEST_DATA_SIZE/dma2plb6_get_bytesize(dma_info.transfer_width);
            dma_info_1.count = TEST_DATA_SIZE/dma2plb6_get_bytesize(dma_info.transfer_width);
            dma_info_2.count = TEST_DATA_SIZE/dma2plb6_get_bytesize(dma_info.transfer_width);
            dma_info_3.count = TEST_DATA_SIZE/dma2plb6_get_bytesize(dma_info.transfer_width);

            if(dma2plb6_multiple_copy(&dma_info, &dma_info_1, &dma_info_2, &dma_info_3, &status) == false){
                dma2plb6_trace_error_status(&status);
                return false;
            } else {
                TEST_ASSERT(compare(source_ea, dest_ea, TEST_DATA_SIZE) == true, "Memory comparison failed");
