...
//***********************************************************************************************************************************************************************************************************
    for (int k=1; k<2; k++){
        ...
        //-------------
        val = 0;
        rumboot_printf("Read, perform and write data from\to %s, src_virt = 0x%x, src_phys = 0x%x%x\n", mem_name[k], src, src_prnt_b, src_prnt_l);
        ...
        *start_signal = 0xBABA0001;
        ...
        asm("msync\n");
        //-------------        
        //rumboot_printf("Pure read of data from %s, src_virt = 0x%x, src_phys = 0x%x%x\n", mem_name[k], src, src_prnt_b, src_prnt_l);
        *start_signal = 0xBABA0002;
        ...
        //-------------        
        rumboot_printf( "Testing function of %s is completed, val = %d\n", mem_name[k], val);
        msync();
    }   
//***********************************************************************************************************************************************************************************************************
// ----- 
