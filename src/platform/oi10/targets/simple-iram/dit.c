...
// Set up interrupt handlers
    ...
    rumboot_irq_set_handler( tbl, DIT_INT0, (int_sense_level << MPIC128_VP_S_i) | (int_pol_high << MPIC128_VP_POL_i), handler0, &in[ 0 ] );
    rumboot_irq_set_handler( tbl, DIT_INT1, (int_sense_level << MPIC128_VP_S_i) | (int_pol_high << MPIC128_VP_POL_i), handler1, &in[ 0 ] );
