...
uint32_t check_plb6mcif2(const uint32_t base_address)
{
    ...
    rumboot_putstring("ACTUAL VALUE PLB6MCIF2_INTR_EN = "); rumboot_puthex(dcr_read(PLB6MCIF2_INTR_EN + base_address));
    ...
    rumboot_putstring("ACTUAL VALUE PLB6MCIF2_MAXMEM = "); rumboot_puthex(dcr_read(PLB6MCIF2_MAXMEM + base_address));
    ...
    rumboot_putstring("ACTUAL VALUE PLB6MCIF2_RID = "); rumboot_puthex(dcr_read(PLB6MCIF2_RID + base_address));
...
uint32_t check_mclfir(const uint32_t base_address)
{
    ...
    rumboot_putstring("ACTUAL VALUE MCLFIR_MC_ERR_MSK1 = "); rumboot_puthex(dcr_read(MCLFIR_MC_ERR_MSK1 + base_address));
    ...
    rumboot_putstring("ACTUAL VALUE MCLFIR_MC_LFIR_MSK = "); rumboot_puthex(dcr_read(MCLFIR_MC_LFIR_MSK + base_address));
    TEST_ASSERT(dcr_read(MCLFIR_MC_LFIR_MSK + base_address) == 0xC0000000,"In MC_LFIR_MSK expected value 0xC0000000");
    rumboot_putstring("ACTUAL VALUE MCLFIR_MC_CONSOL_STAT = "); rumboot_puthex(dcr_read(MCLFIR_MC_CONSOL_STAT + base_address));
    ...
    rumboot_putstring("ACTUAL VALUE MCLFIR_MC_CONSOL_STAT_MSK = "); rumboot_puthex(dcr_read(MCLFIR_MC_CONSOL_STAT_MSK + base_address));
