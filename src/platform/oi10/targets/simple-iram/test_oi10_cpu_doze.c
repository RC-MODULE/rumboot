...
int main ()
{
    ...
    TEST_ASSERT(rumboot_platform_get_uptime() - start_mpic > DELAY/25, "DOZE MODE ERROR");
    ...
    ppc470s_enter_doze_mode();
    test_event(EVENT_TIME_2);
    TEST_ASSERT(rumboot_platform_get_uptime() - start_dit0 > DELAY/25, "DOZE MODE ERROR");
    ...
    ppc470s_enter_doze_mode();
    test_event(EVENT_TIME_2);
    TEST_ASSERT(rumboot_platform_get_uptime() - start_dec > DELAY2/200, "DOZE MODE ERROR");
    ...
    ppc470s_enter_doze_mode();
    test_event(EVENT_TIME_2);
    TEST_ASSERT(rumboot_platform_get_uptime() - start_fit > DELAY2/200, "DOZE MODE ERROR");
    ...
    ppc470s_enter_doze_mode();
    test_event(EVENT_TIME_2);
    TEST_ASSERT(rumboot_platform_get_uptime() - start_wd > DELAY2/200, "DOZE MODE ERROR");
