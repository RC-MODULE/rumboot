...
void check_sram0_8 (uint32_t const addr, tx_type const tx)
{
...
void check_sram0_16 (uint32_t const addr, tx_type const tx)
{
...
void check_sram0_32 (uint32_t addr, tx_type tx)
{
...
void check_sram0_64 (uint32_t addr, tx_type tx)
{
...
void check_sram0 (const uint32_t addr, tx_type state)
{
...
#define TLB_ENTRY_CACHE_WT  MMU_TLB_ENTRY(  0x000,  0x00000,    0x00000,    MMU_TLBE_DSIZ_1GB,      0b0,    0b0,    0b1,    0b0,    0b1,    0b0,    MMU_TLBE_E_BIG_END,     0b0,0b0,0b0,    0b0,0b1,0b1,    0b0,    0b0,        0b0,    MEM_WINDOW_0,     MMU_TLBWE_WAY_3,      MMU_TLBWE_BE_UND,   0b1 )
#define TLB_ENTRY_CACHE_WB  MMU_TLB_ENTRY(  0x000,  0x00000,    0x00000,    MMU_TLBE_DSIZ_1GB,      0b0,    0b0,    0b0,    0b0,    0b1,    0b0,    MMU_TLBE_E_BIG_END,     0b0,0b0,0b0,    0b0,0b1,0b1,    0b0,    0b0,        0b0,    MEM_WINDOW_0,     MMU_TLBWE_WAY_3,      MMU_TLBWE_BE_UND,   0b1 )
...
int main ()
{
    ...
    memset( (void*)(SRAM0_BASE + SRAM0_OFFSET_WT), 0x00, 4*NUM_ELEM );
    memset( (void*)(SRAM0_BASE + SRAM0_OFFSET_WB), 0x00, 4*NUM_ELEM );
