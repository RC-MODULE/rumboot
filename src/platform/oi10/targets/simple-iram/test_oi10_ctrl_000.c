...
static uint8_t APB_check_ctrl_regs_ro(uint32_t base_addr)
{   
    rumboot_printf("Checking registers default value...\n");
      struct regpoker_checker check_array[] = {
      { "SYS_BOOT_CFG_BOOTM7", REGPOKER_READ32, SYS_BOOT_CFG, 0x0, 0xf },
      { "SYS_BOOT_CFG_BOOTM6", REGPOKER_READ32, SYS_BOOT_CFG << 1, 0x0, 0xf },
      { "SYS_BOOT_CFG_BOOTM2", REGPOKER_READ32, SYS_BOOT_CFG << 2, 0x0, 0xf },
      { "SYS_BOOT_CFG_BOOTM1", REGPOKER_READ32, SYS_BOOT_CFG << 3, 0x0, 0xf },
      { "SYS_BOOT_CFG_BOOTM0", REGPOKER_READ32, SYS_BOOT_CFG, 0x0, 0xf },
      {  }
    };
...
static int AXI_check_regs32(uint32_t base_addr)
{
    ...
    { "NIC400_GSPI_1_S_WQOS", REGPOKER_WRITE32, NIC400_GSPI_1_S_WQOS, 0x0,
0b1111 },

    { "NIC400_GSPI_1_S_FN_MOD", REGPOKER_READ32, NIC400_GSPI_1_S_FN_MOD, 0x0,
0b11 },
    { "NIC400_GSPI_1_S_FN_MOD", REGPOKER_WRITE32, NIC400_GSPI_1_S_FN_MOD, 0x0,
0b11 },
    ...
    { "NIC400_ETH_1_S_FN_MOD", REGPOKER_WRITE32, NIC400_ETH_1_S_FN_MOD, 0x0,
0b11 },

    { "NIC400_SW_0_3_S_RQOS", REGPOKER_READ32, NIC400_SW_0_3_S_RQOS, 0x4, 0b1111
},
    { "NIC400_SW_0_3_S_RQOS", REGPOKER_WRITE32, NIC400_SW_0_3_S_RQOS, 0x4,
0b1111 },

    { "NIC400_SW_0_3_S_WQOS", REGPOKER_READ32, NIC400_SW_0_3_S_WQOS, 0x4, 0b1111
},
    { "NIC400_SW_0_3_S_WQOS", REGPOKER_WRITE32, NIC400_SW_0_3_S_WQOS, 0x4,
0b1111 },

    { "NIC400_SW_0_3_S_FN_MOD", REGPOKER_READ32, NIC400_SW_0_3_S_FN_MOD, 0x0,
0b11 },
    { "NIC400_SW_0_3_S_FN_MOD", REGPOKER_WRITE32, NIC400_SW_0_3_S_FN_MOD, 0x0,
0b11 },

    { "NIC400_GSPI_0_S_RQOS", REGPOKER_READ32, NIC400_GSPI_0_S_RQOS, 0x0, 0b1111
},
    { "NIC400_GSPI_0_S_RQOS", REGPOKER_WRITE32, NIC400_GSPI_0_S_RQOS, 0x0,
0b1111 },

    { "NIC400_GSPI_0_S_WQOS", REGPOKER_READ32, NIC400_GSPI_0_S_WQOS, 0x0, 0b1111
},
    { "NIC400_GSPI_0_S_WQOS", REGPOKER_WRITE32, NIC400_GSPI_0_S_WQOS, 0x0,
0b1111 },

    { "NIC400_GSPI_0_S_FN_MOD", REGPOKER_READ32, NIC400_GSPI_0_S_FN_MOD, 0x0,
0b11 },
    { "NIC400_GSPI_0_S_FN_MOD", REGPOKER_WRITE32, NIC400_GSPI_0_S_FN_MOD, 0x0,
0b11 },
    ...
    { "NIC400_ETH_0_S_FN_MOD", REGPOKER_WRITE32, NIC400_ETH_0_S_FN_MOD, 0x0,
0b11 },

    { "NIC400_MKIO_0_S_RQOS", REGPOKER_READ32, NIC400_MKIO_0_S_RQOS, 0x0, 0b1111
},
    { "NIC400_MKIO_0_S_RQOS", REGPOKER_WRITE32, NIC400_MKIO_0_S_RQOS, 0x0,
0b1111 },

    { "NIC400_MKIO_0_S_WQOS", REGPOKER_READ32, NIC400_MKIO_0_S_WQOS, 0x0, 0b1111
},
    { "NIC400_MKIO_0_S_WQOS", REGPOKER_WRITE32, NIC400_MKIO_0_S_WQOS, 0x0,
0b1111 },

    { "NIC400_MKIO_0_S_FN_MOD", REGPOKER_READ32, NIC400_MKIO_0_S_FN_MOD, 0x0,
0b11 },
    { "NIC400_MKIO_0_S_FN_MOD", REGPOKER_WRITE32, NIC400_MKIO_0_S_FN_MOD, 0x0,
0b11 },

    { "NIC400_MKIO_1_S_RQOS", REGPOKER_READ32, NIC400_MKIO_1_S_RQOS, 0x0, 0b1111
},
    { "NIC400_MKIO_1_S_RQOS", REGPOKER_WRITE32, NIC400_MKIO_1_S_RQOS, 0x0,
0b1111 },

    { "NIC400_MKIO_1_S_WQOS", REGPOKER_READ32, NIC400_MKIO_1_S_WQOS, 0x0, 0b1111
},
    { "NIC400_MKIO_1_S_WQOS", REGPOKER_WRITE32, NIC400_MKIO_1_S_WQOS, 0x0,
0b1111 },

    { "NIC400_MKIO_1_S_FN_MOD", REGPOKER_READ32, NIC400_MKIO_1_S_FN_MOD, 0x0,
0b11 },
    { "NIC400_MKIO_1_S_FN_MOD", REGPOKER_WRITE32, NIC400_MKIO_1_S_FN_MOD, 0x0,
0b11 },
...
int main(void)
{
   ...
   result = AXIx_check_ID_regs(DCR_CTRL_BASE) ||
