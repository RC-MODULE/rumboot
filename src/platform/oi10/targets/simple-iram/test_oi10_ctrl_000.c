...
static int check_ctrl_regs_rw(uint32_t base_addr)
{
    ...
    { "PPC_SYS_CONF", REGPOKER_READ_DCR, PPC_SYS_CONF, 0b11000, 0b11111 },
    { "PPC_SYS_CONF", REGPOKER_READ_DCR, PPC_SYS_CONF, 0b0, 0b1 },
    { "PPC_SLP_CTRL", REGPOKER_READ_DCR, PPC_SLP_CTRL, 0b0000, 0b1111 },
    { "PPC_PMU_CTRL", REGPOKER_READ_DCR, PPC_PMU_CTRL, 0b00000, 0b11111 },
    { "IFSYS_ETH_CTRL", REGPOKER_READ_DCR, IFSYS_ETH_CTRL, 0b0000, 0b1111 },
    { "IFSYS_ETH_CTRL", REGPOKER_READ_DCR, IFSYS_ETH_CTRL, 0x10000, 0x11111 },
    { "IFSYS_ETH_HPROT", REGPOKER_READ_DCR, IFSYS_ETH_HPROT, 0x33333333, 0xffffffff },
    {  }
    };
    if( rumboot_regpoker_check_array( check_array, base_addr ) == 0 ) {
           rumboot_printf( "OK\n" );
