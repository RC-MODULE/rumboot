...
struct regpoker_checker hscb_read_checker[] = {
    //{"ID               ", REGPOKER_READ32, HSCB_ID,              HSCB_ID_DFLT,              0xffffffff}, // new // RO
    //{"VERSION          ", REGPOKER_READ32, HSCB_VERSION,         HSCB_VERSION_DFLT,         0xffffffff}, // new // RO
    ...
    //{"TIME_CODE_INNER  ", REGPOKER_READ32, HSCB_TIME_CODE_INNER, HSCB_TIME_CODE_INNER_DFLT, 0xffffffff}, // new // RO
    //{"TIME_CODE_OUTER  ", REGPOKER_READ32, HSCB_TIME_CODE_OUTER, HSCB_TIME_CODE_OUTER_DFLT, 0xffffffff}, // new // RO
    {"RMAP_PARAMS      ", REGPOKER_READ32, HSCB_RMAP_PARAMS,     HSCB_RMAP_PARAMS_DFLT,     0xffffffff}, // new
    //{"RMAP_C_STATUS    ", REGPOKER_READ32, HSCB_RMAP_C_STATUS,   HSCB_RMAP_C_STATUS_DFLT,   0xffffffff}, // new // RO
    //{"ADMA_ID          ", REGPOKER_READ32, HSCB_ADMA_ID,         HSCB_ADMA_ID_DFLT,         0xffffffff}, // new // RO
    //{"ADMA_REV         ", REGPOKER_READ32, HSCB_ADMA_REV,        HSCB_ADMA_REV_DFLT,        0xffffffff}, // new // RO
    {"ADMA_SW_RESET    ", REGPOKER_READ32, HSCB_ADMA_SW_RESET,   HSCB_ADMA_SW_RESET_DFLT,   0xffffffff}, // new
    //{"ADMA_CH_STATUS   ", REGPOKER_READ32, HSCB_ADMA_CH_STATUS,  HSCB_ADMA_CH_STATUS_DFLT,  0xffffffff}, // new // RO
    ...
    //{"BRESP            ", REGPOKER_READ32, HSCB_BRESP,           HSCB_BRESP_DFLT,           0x00000003}, // new // RO
    //{"RAXI_ERR_ADDR    ", REGPOKER_READ32, HSCB_RAXI_ERR_ADDR,   HSCB_RAXI_ERR_ADDR_DFLT,   0xffffffff}, // new // RO
    ...
    //{"RDMA_STATUS      ", REGPOKER_READ32, HSCB_RDMA_STATUS,     HSCB_RDMA_STATUS_DFLT,     0xffffffff}, // new // RO
    ...
    //{"RDMA_ADDR        ", REGPOKER_READ32, HSCB_RDMA_ADDR,       HSCB_RDMA_ADDR_DFLT,       0xffffffff}, // new // RO
    //{"RDMA_LEN         ", REGPOKER_READ32, HSCB_RDMA_LEN,        HSCB_RDMA_LEN_DFLT,        0xffffffff}, // new // RO
    ...
    //{"WDMA_STATUS      ", REGPOKER_READ32, HSCB_WDMA_STATUS,     HSCB_WDMA_STATUS_DFLT,     0xffffffff}, // new // RO
    ...
    //{"WDMA_ADDR        ", REGPOKER_READ32, HSCB_WDMA_ADDR,       HSCB_WDMA_ADDR_DFLT,       0xffffffff}, // new // RO
    //{"WDMA_LEN         ", REGPOKER_READ32, HSCB_WDMA_LEN,        HSCB_WDMA_LEN_DFLT,        0xffffffff}, // new // RO
...
struct regpoker_checker sdio_read_checker[] = {
    ...
    //{"SDIO_SDR_RESPONSE1_REG         ", REGPOKER_READ32, SDIO_SDR_RESPONSE1_REG,      SDIO_SDR_RESPONSE1_REG_DFLT,      0xffffffff}, // new // RO
    //{"SDIO_SDR_RESPONSE2_REG         ", REGPOKER_READ32, SDIO_SDR_RESPONSE2_REG,      SDIO_SDR_RESPONSE2_REG_DFLT,      0xffffffff}, // new // RO
    //{"SDIO_SDR_RESPONSE3_REG         ", REGPOKER_READ32, SDIO_SDR_RESPONSE3_REG,      SDIO_SDR_RESPONSE3_REG_DFLT,      0xffffffff}, // new // RO
    //{"SDIO_SDR_RESPONSE4_REG         ", REGPOKER_READ32, SDIO_SDR_RESPONSE4_REG,      SDIO_SDR_RESPONSE4_REG_DFLT,      0xffffffff}, // new // RO
    ...
    //{"SDIO_DMA_CHANEL_FINISH_REG     ", REGPOKER_READ32, SDIO_DMA_CHANEL_FINISH_REG,  SDIO_DMA_CHANEL_FINISH_REG_DFLT,  0x00000003}, // new // RO
    ...
    //{"SDIO_INT_STATUS                ", REGPOKER_READ32, SDIO_INT_STATUS,             SDIO_INT_STATUS_DFLT,             0x000000ff}, // new // RO
...
struct regpoker_checker mkio_checker[] =
    {
        ...
        //{"HWCFG  ", REGPOKER_READ32, HWCFG,   0x00000000, 0xFFFFFFFF}, // RO
        {"BCSL   ", REGPOKER_READ32, BCSL,    0xF0000000, 0xFFFFFFFF},
        //{"BCA    ", REGPOKER_READ32, BCA,     0x00000000, 0xFFFFFFFF}, //WO
        {"BCTNP  ", REGPOKER_READ32, BCTNP,   0x00000000, 0xFFFFFFFF},
        {"BCANP  ", REGPOKER_READ32, BCANP,   0x00000000, 0xFFFFFFFF},
        //{"BCT    ", REGPOKER_READ32, BCT,     0x00000000, 0xFFFFFFFF}, // RO
        ...
        //{"BCTCP  ", REGPOKER_READ32, BCTCP,   0x00000000, 0xFFFFFFFF}, // RO
        //{"BCACP  ", REGPOKER_READ32, BCACP,   0x00000000, 0xFFFFFFFF}, // RO
        //{"RTS    ", REGPOKER_READ32, RTS,     0x80000000, 0xFFFFFFFF}, // RO
        ...
        //{"RTSY   ", REGPOKER_READ32, RTSY,    0x00000000, 0xFFFFFFFF}, // RO
        ...
        //{"RTELIP ", REGPOKER_READ32, RTELIP,  0x00000000, 0xFFFFFFFF}, // RO
        //{"BMS    ", REGPOKER_READ32, BMS,     0x80000000, 0xFFFFFFFF}, // RO
...
struct regpoker_checker uart_checker[] = {
    ...
    //{"UARTFR",        REGPOKER_READ32,  UARTFR,          UARTFR_DEFAULT,        UARTFR_MSK          }, // RO
    ...
    //{"UARTRIS",       REGPOKER_READ32,  UARTRIS,         UARTRIS_DEFAULT,       UARTRIS_MSK         }, // RO
    //{"UARTMIS",       REGPOKER_READ32,  UARTMIS,         UARTMIS_DEFAULT,       UARTMIS_MSK         }, // RO
    {"UARTDMACR",     REGPOKER_READ32,  UARTDMACR,       UARTDMACR_DEFAULT,     UARTDMACR_MSK       },
    //{"UARTPeriphID0", REGPOKER_READ32,  UARTPeriphID0,   UARTPeriphID0_DEFAULT, UARTPeriphID0_MSK   }, // RO
    //{"UARTPeriphID1", REGPOKER_READ32,  UARTPeriphID1,   UARTPeriphID1_DEFAULT, UARTPeriphID1_MSK   }, // RO
    //{"UARTPeriphID2", REGPOKER_READ32,  UARTPeriphID2,   UARTPeriphID2_DEFAULT, UARTPeriphID2_MSK   }, // RO
    //{"UARTPeriphID3", REGPOKER_READ32,  UARTPeriphID3,   UARTPeriphID3_DEFAULT, UARTPeriphID3_MSK   }, // RO
    //{"UARTPCellID0",  REGPOKER_READ32,  UARTPCellID0,    UARTPCellID0_DEFAULT,  UARTPCellID0_MSK    }, // RO
    //{"UARTPCellID1",  REGPOKER_READ32,  UARTPCellID1,    UARTPCellID1_DEFAULT,  UARTPCellID1_MSK    }, // RO
    //{"UARTPCellID2",  REGPOKER_READ32,  UARTPCellID2,    UARTPCellID2_DEFAULT,  UARTPCellID2_MSK    }, // RO
    //{"UARTPCellID3",  REGPOKER_READ32,  UARTPCellID3,    UARTPCellID3_DEFAULT,  UARTPCellID3_MSK    }, // RO
...
static struct regpoker_checker const spi_checker[] = {
    ...
    //{"SSPSR",        REGPOKER_READ32,  GSPI_SSPSR,          GSPI_SSPSR_DEFAULT,        GSPI_SSPSR_MASK             }, // RO
    ...
    //{"SSPRIS",       REGPOKER_READ32,  GSPI_SSPRIS,         GSPI_SSPRIS_DEFAULT,       GSPI_SSPRIS_MASK            }, // RO
    {"SSPDMACR",     REGPOKER_READ32,  GSPI_SSPDMACR,       GSPI_SSPDMACR_DEFAULT,     GSPI_SSPDMACR_MASK          },
    //{"SSPPeriphID0", REGPOKER_READ32,  GSPI_SSPPeriphID0,   GSPI_SSPPeriphID0_DEFAULT, GSPI_SSPPeriphID0_MASK      }, // RO
    //{"SSPPeriphID1", REGPOKER_READ32,  GSPI_SSPPeriphID1,   GSPI_SSPPeriphID1_DEFAULT, GSPI_SSPPeriphID1_MASK      }, // RO
    //{"SSPPeriphID2", REGPOKER_READ32,  GSPI_SSPPeriphID2,   GSPI_SSPPeriphID2_DEFAULT, GSPI_SSPPeriphID2_MASK      }, // RO
    //{"SSPPeriphID3", REGPOKER_READ32,  GSPI_SSPPeriphID3,   GSPI_SSPPeriphID3_DEFAULT, GSPI_SSPPeriphID3_MASK      }, // RO
    //{"SSPPCellID0",  REGPOKER_READ32,  GSPI_SSPPCellID0,    GSPI_SSPPCellID0_DEFAULT,  GSPI_SSPPCellID0_MASK       }, // RO
    //{"SSPPCellID1",  REGPOKER_READ32,  GSPI_SSPPCellID1,    GSPI_SSPPCellID1_DEFAULT,  GSPI_SSPPCellID1_MASK       }, // RO
    //{"SSPPCellID2",  REGPOKER_READ32,  GSPI_SSPPCellID2,    GSPI_SSPPCellID2_DEFAULT,  GSPI_SSPPCellID2_MASK       }, // RO
    //{"SSPPCellID3",  REGPOKER_READ32,  GSPI_SSPPCellID3,    GSPI_SSPPCellID3_DEFAULT,  GSPI_SSPPCellID3_MASK       }, // RO
    {"SSPCR0",       REGPOKER_WRITE32, GSPI_SSPCR0,         0x00,                      GSPI_SSPCR0_MASK            },
    {"SSPCR1",       REGPOKER_WRITE32, GSPI_SSPCR1,         0x00,                      GSPI_SSPCR1_MASK            },
    //{"SSPCPSR",      REGPOKER_WRITE32, GSPI_SSPCPSR,        0x00,                      GSPI_SSPCPSR_MASK & ~0x01   }, // RO
    ...
    //{"DMAWCUR",      REGPOKER_READ32,  GSPI_DMAWCUR,        GSPI_DMAWCUR_DEFAULT,      GSPI_DMAWCUR_MASK           }, // RO
    //{"AXIW_BRESP",   REGPOKER_READ32,  GSPI_AXIW_BRESP,     GSPI_AXIW_BRESP_DEFAULT,   GSPI_AXIW_BRESP_MASK        }, // RO
    ...
    //{"DMARCUR",      REGPOKER_READ32,  GSPI_DMARCUR,        GSPI_DMARCUR_DEFAULT,      GSPI_DMARCUR_MASK           }, // RO
    ...
    //{"AXIR_ERRADDR", REGPOKER_READ32,  GSPI_AXIR_ERRADDR,   GSPI_AXIR_ERRADDR_DEFAULT, GSPI_AXIR_ERRADDR_MASK      }, // RO
...
struct regpoker_checker gpio_checker[] = {
    ...
    //{"GPIO_RIS",       REGPOKER_READ32, GPIO_RIS,       GPIO_RIS_DEFAULT,       GPIO_REG_MASK   }, // RO 
    //{"GPIO_MIS",       REGPOKER_READ32, GPIO_MIS,       GPIO_MIS_DEFAULT,       GPIO_REG_MASK   }, // RO
    {"GPIO_AFSEL",     REGPOKER_READ32, GPIO_AFSEL,     GPIO_AFSEL_DEFAULT,     GPIO_REG_MASK   },
    //{"GPIO_PeriphID0", REGPOKER_READ32, GPIO_PeriphID0, GPIO_PeriphID0_DEFAULT, GPIO_REG_MASK   }, // RO
    //{"GPIO_PeriphID1", REGPOKER_READ32, GPIO_PeriphID1, GPIO_PeriphID1_DEFAULT, GPIO_REG_MASK   }, // RO
    //{"GPIO_PeriphID2", REGPOKER_READ32, GPIO_PeriphID2, GPIO_PeriphID2_DEFAULT, GPIO_REG_MASK   }, // RO
    //{"GPIO_PeriphID3", REGPOKER_READ32, GPIO_PeriphID3, GPIO_PeriphID3_DEFAULT, GPIO_REG_MASK   }, // RO
    //{"GPIO_CellID0",   REGPOKER_READ32, GPIO_CellID0,   GPIO_CellID0_DEFAULT,   GPIO_REG_MASK   }, // RO
    //{"GPIO_CellID1",   REGPOKER_READ32, GPIO_CellID1,   GPIO_CellID1_DEFAULT,   GPIO_REG_MASK   }, // RO
    //{"GPIO_CellID2",   REGPOKER_READ32, GPIO_CellID2,   GPIO_CellID2_DEFAULT,   GPIO_REG_MASK   }, // RO
    //{"GPIO_CellID3",   REGPOKER_READ32, GPIO_CellID3,   GPIO_CellID3_DEFAULT,   GPIO_REG_MASK   }, // RO
    {/* Sentinel */}};
...
struct regpoker_checker wdt_checker[] = {
    //{"WD_REG_PERIPHID0", REGPOKER_READ_DCR, WD_REG_PERIPHID0, WD_REG_PERIPHID0_DFLT, WD_REG_PERIPHID0_mask   }, // RO
    //{"WD_REG_PERIPHID1", REGPOKER_READ_DCR, WD_REG_PERIPHID1, WD_REG_PERIPHID1_DFLT, WD_REG_PERIPHID1_mask   }, // RO
    //{"WD_REG_PERIPHID2", REGPOKER_READ_DCR, WD_REG_PERIPHID2, WD_REG_PERIPHID2_DFLT, WD_REG_PERIPHID2_mask   }, // RO
    //{"WD_REG_PERIPHID3", REGPOKER_READ_DCR, WD_REG_PERIPHID3, WD_REG_PERIPHID3_DFLT, WD_REG_PERIPHID3_mask   }, // RO
    //{"WD_REG_PCELLID0",  REGPOKER_READ_DCR, WD_REG_PCELLID0,  WD_REG_PCELLID0_DFLT,  WD_REG_PCELLID0_mask    }, // RO
    //{"WD_REG_PCELLID1",  REGPOKER_READ_DCR, WD_REG_PCELLID1,  WD_REG_PCELLID1_DFLT,  WD_REG_PCELLID1_mask    }, // RO
    //{"WD_REG_PCELLID2",  REGPOKER_READ_DCR, WD_REG_PCELLID2,  WD_REG_PCELLID2_DFLT,  WD_REG_PCELLID2_mask    }, // RO
    //{"WD_REG_PCELLID3",  REGPOKER_READ_DCR, WD_REG_PCELLID3,  WD_REG_PCELLID3_DFLT,  WD_REG_PCELLID3_mask    }, // RO
    //{"WdogValue",        REGPOKER_READ_DCR, WD_REG_VALUE,     WD_REG_VALUE_DFLT,     WD_REG_VALUE_mask       }, // RO
    {}};
...
struct regpoker_checker wdt_rw_checker[] = {
    ...
    //{"WdogRIS",     REGPOKER_READ_DCR,  WD_REG_RIS,     WD_REG_RIS_DFLT,     WD_REG_RIS_mask       }, // RO
    //{"WdogMIS",     REGPOKER_READ_DCR,  WD_REG_MIS,     WD_REG_MIS_DFLT,     WD_REG_MIS_mask       }, // RO
...
struct regpoker_checker crg_checker[] = {
    //{"CRG_SYS_PLL_STAT",   REGPOKER_READ_DCR, CRG_SYS_PLL_STAT,   0x00000011, 0x00000011   }, // RO
...
static const struct regpoker_checker plb6plb4_0_regs_default[] = {
    ...
    //{"PLB6PLB4_ESR   ",      REGPOKER_READ_DCR, ESR   ,      ESR_RESET_VAL,         ESR_MSK      }, //RC
    //{"PLB6PLB4_P64REV",      REGPOKER_READ_DCR, P64REV,      P64REV_RESET_VAL,      P64REV_MSK   }, // RO
    //{"PLB6PLB4_EARH  ",      REGPOKER_READ_DCR, EARH  ,      EARH_RESET_VAL,        EARH_MSK     }, // RO
    //{"PLB6PLB4_EARL  ",      REGPOKER_READ_DCR, EARL  ,      EARL_RESET_VAL,        EARL_MSK     }, // RO
    ...
    //{"PLB6PLB4_TESR  ",      REGPOKER_READ_DCR, TESR  ,      TESR_RESET_VAL,        TESR_MSK     }, // WO
...
static const struct regpoker_checker cldcr_regs_default[] = {
    //      name                check type          offset         exp val                  mask
    //{"CLDCR_TCRREV",       REGPOKER_READ_DCR, CLDCR_TCRREV,      CLDCR_TCRREV_DFLT,       CLDCR_TCRREV_MSK    }, // RO
...
static const struct regpoker_checker plb4arb8m_0_regs_default[] = {
    //name         check type         offset     exp val                  mask
    //{"PREV",       REGPOKER_READ_DCR, PREV,      PREV_0_RESET_VAL,       PREV_MSK   }, // RO
...
static const struct regpoker_checker plb4arb8m_2_regs_default[] = {
    //name         check type         offset     exp val                  mask
    //{"PREV",       REGPOKER_READ_DCR, PREV,      0x00000000,             PREV_MSK   }, // RO
...
static const struct regpoker_checker plb4ahb_regs_default[] = {
    ...
    //name                   check type         offset               exp val                     mask  
    //uni-directional
    //{"REVID",                REGPOKER_READ_DCR, REVID,               REVID_VALUE,                REVID_MSK            }, //RO
...
static const struct regpoker_checker mpic128_regs_default[] = {
    ...
    //{"MPIC128_WAI0",                REGPOKER_READ_DCR, MPIC128_WAI0,               MPIC128_WAI0_VALUE,                MPIC128_WAIx_MSK},    // RO
    //{"MPIC128_WAI1",                REGPOKER_READ_DCR, MPIC128_WAI1,               MPIC128_WAI1_VALUE,                MPIC128_WAIx_MSK},    // RO
    //{"MPIC128_WAI2",                REGPOKER_READ_DCR, MPIC128_WAI2,               MPIC128_WAI2_VALUE,                MPIC128_WAIx_MSK},    // RO
    //{"MPIC128_WAI3",                REGPOKER_READ_DCR, MPIC128_WAI3,               MPIC128_WAI3_VALUE,                MPIC128_WAIx_MSK},    // RO
    //{"MPIC128_NCIAR0",              REGPOKER_READ_DCR, MPIC128_NCIAR0,             MPIC128_NCIAR0_VALUE,              MPIC128_NCIARx_MSK},  // RO
    //{"MPIC128_NCIAR1",              REGPOKER_READ_DCR, MPIC128_NCIAR1,             MPIC128_NCIAR1_VALUE,              MPIC128_NCIARx_MSK},  // RO
    //{"MPIC128_NCIAR2",              REGPOKER_READ_DCR, MPIC128_NCIAR2,             MPIC128_NCIAR2_VALUE,              MPIC128_NCIARx_MSK},  // RO
    //{"MPIC128_NCIAR3",              REGPOKER_READ_DCR, MPIC128_NCIAR3,             MPIC128_NCIAR3_VALUE,              MPIC128_NCIARx_MSK},  // RO
    ...
    //{"MPIC128_CIAR0",               REGPOKER_READ_DCR, MPIC128_CIAR0,              MPIC128_CIAR0_VALUE,               MPIC128_CIARx_MSK}, // RO
    //{"MPIC128_CIAR1",               REGPOKER_READ_DCR, MPIC128_CIAR1,              MPIC128_CIAR1_VALUE,               MPIC128_CIARx_MSK}, // RO
    //{"MPIC128_CIAR2",               REGPOKER_READ_DCR, MPIC128_CIAR2,              MPIC128_CIAR2_VALUE,               MPIC128_CIARx_MSK}, // RO
    //{"MPIC128_CIAR3",               REGPOKER_READ_DCR, MPIC128_CIAR3,              MPIC128_CIAR3_VALUE,               MPIC128_CIARx_MSK}, // RO
    ...
    //{"MPIC128_IAR0",                REGPOKER_READ_DCR, MPIC128_IAR0,               MPIC128_IAR0_VALUE,                MPIC128_IARx_MSK}, // RO
    //{"MPIC128_IAR1",                REGPOKER_READ_DCR, MPIC128_IAR1,               MPIC128_IAR1_VALUE,                MPIC128_IARx_MSK}, // RO
    //{"MPIC128_IAR2",                REGPOKER_READ_DCR, MPIC128_IAR2,               MPIC128_IAR2_VALUE,                MPIC128_IARx_MSK}, // RO
    //{"MPIC128_IAR3",                REGPOKER_READ_DCR, MPIC128_IAR3,               MPIC128_IAR3_VALUE,                MPIC128_IARx_MSK}, // RO
    ...
    //{"MPIC128_FRG0",                REGPOKER_READ_DCR, MPIC128_FRG0,               MPIC128_FRG0_VALUE,                MPIC128_FRG0_MSK}, //  RO
    ...
    //{"MPIC128_REVID",               REGPOKER_READ_DCR, MPIC128_REVID,              MPIC128_REVID_VALUE,               MPIC128_REVID_MSK}, // RO
    //{"MPIC128_VIR",                 REGPOKER_READ_DCR, MPIC128_VIR0,               MPIC128_VIR0_VALUE,                MPIC128_VIR0_MSK}, // RO
    ...
    //{"MPIC128_TCC0",                REGPOKER_READ_DCR, MPIC128_TCC0,               MPIC128_TCC0_VALUE,                MPIC128_TCCx_MSK}, // RO
    //{"MPIC128_TCC1",                REGPOKER_READ_DCR, MPIC128_TCC1,               MPIC128_TCC1_VALUE,                MPIC128_TCCx_MSK}, // RO
    //{"MPIC128_TCC2",                REGPOKER_READ_DCR, MPIC128_TCC2,               MPIC128_TCC2_VALUE,                MPIC128_TCCx_MSK}, // RO
    //{"MPIC128_TCC3",                REGPOKER_READ_DCR, MPIC128_TCC3,               MPIC128_TCC3_VALUE,                MPIC128_TCCx_MSK}, // RO
...
static const struct regpoker_checker dcrarb_regs_default[] = {
    ...
    //{"DCRARB_DAEAR         ",    REGPOKER_READ_DCR, DCRARB_DAEAR     ,   DCRARB_DAEAR_VALUE     ,       DCRARB_DAEAR_MSK     }, // RO
    //{"DCRARB_DASMR         ",    REGPOKER_READ_DCR, DCRARB_DASMR     ,   DCRARB_DASMR_VALUE     ,       DCRARB_DASMR_MSK     },
    //{"DCRARB_REVID         ",    REGPOKER_READ_DCR, DCRARB_REVID     ,   DCRARB_REVID_VALUE     ,       DCRARB_REVID_MSK     }, // RO
...
static const struct regpoker_checker itrace_regs_default[] = {
    ...
    //{"ITC0_TS           ",    REGPOKER_READ_DCR, ITC0_TS       ,   ITC0_TS_DEFAULT       ,       ITC0_TS_MSK       }, // RC
    //{"ITC0_TLA1         ",    REGPOKER_READ_DCR, ITC0_TLA1     ,   ITC0_TLA1_DEFAULT     ,       ITC0_TLA1_MSK     }, // RO
    //{"ITC0_TLA2         ",    REGPOKER_READ_DCR, ITC0_TLA2     ,   ITC0_TLA2_DEFAULT     ,       ITC0_TLA2_MSK     }, // RO
...
static const struct regpoker_checker ltrace_regs_default[] = {
    ...
    //{"LTR_TS            ",    REGPOKER_READ_DCR, LTR_TS        ,   LTR_TS_DEFAULT      ,       LTR_TS_MSK      }, // RC
    //{"LTR_LA1           ",    REGPOKER_READ_DCR, LTR_LA1       ,   LTR_LA1_DEFAULT     ,       LTR_LA1_MSK     }, // RO
    //{"LTR_LA2           ",    REGPOKER_READ_DCR, LTR_LA2       ,   LTR_LA2_DEFAULT     ,       LTR_LA2_MSK     }, // RO
...
static const struct regpoker_checker plb6bc_regs_default[] = {
    ...
    //{"PLB6BC_REVID         ",           REGPOKER_READ_DCR, PLB6BC_REVID         ,          0x00000102,                 PLB6BC_REVID_MSK          }, // RO
...
static const struct regpoker_checker dma2plb6_regs_default[] = {
    ...
    //{"CHLOCK0",                REGPOKER_READ_DCR, PLB6_DMA_CHLOCK0,        PLB6_DMA_CHLOCK0_DEFAULT,   PLB6_DMA_CHLOCK0_MSK}, // RC
    ...
    //{"CHLOCK1",                REGPOKER_READ_DCR, PLB6_DMA_CHLOCK1,        PLB6_DMA_CHLOCK1_DEFAULT,   PLB6_DMA_CHLOCK1_MSK}, // RC
    ...
    //{"CHLOCK2",                REGPOKER_READ_DCR, PLB6_DMA_CHLOCK2,        PLB6_DMA_CHLOCK2_DEFAULT,   PLB6_DMA_CHLOCK2_MSK}, // RC
    ...
    //{"CHLOCK3",                REGPOKER_READ_DCR, PLB6_DMA_CHLOCK3,        PLB6_DMA_CHLOCK3_DEFAULT,   PLB6_DMA_CHLOCK3_MSK}, // RC
    {"SGCA3  ",                REGPOKER_READ_DCR, PLB6_DMA_SGCA3  ,        PLB6_DMA_SGCA3_DEFAULT,     PLB6_DMA_SGCA3_MSK},
    //{"SR     ",                REGPOKER_READ_DCR, PLB6_DMA_SR     ,        PLB6_DMA_SR_DEFAULT,        PLB6_DMA_SR_MSK}, // RC
    //{"PMEAH  ",                REGPOKER_READ_DCR, PLB6_DMA_PMEAH  ,        PLB6_DMA_PMEAH_DEFAULT,     PLB6_DMA_PMEAx_MSK}, // RO
    //{"PMEAL  ",                REGPOKER_READ_DCR, PLB6_DMA_PMEAL  ,        PLB6_DMA_PMEAL_DEFAULT,     PLB6_DMA_PMEAx_MSK}, // RO
    //{"PSE    ",                REGPOKER_READ_DCR, PLB6_DMA_PSE    ,        PLB6_DMA_PSE_DEFAULT,       PLB6_DMA_PSE_MSK}, // RC
    ...
    //{"CRS    ",                REGPOKER_READ_DCR, PLB6_DMA_CRS    ,        PLB6_DMA_CRS_DEFAULT,       PLB6_DMA_CRS_MSK}, // RC
    //{"REVID  ",                REGPOKER_READ_DCR, PLB6_DMA_REVID  ,        PLB6_DMA_REVID_DEFAULT,     PLB6_DMA_REVID_MSK}, // RO
    ...
    //{"PNC   ",                 REGPOKER_READ_DCR, PLB6_DMA_PNC   ,         PLB6_DMA_PNC_DEFAULT,       PLB6_DMA_PNC_MSK}, // RO
...
static const struct regpoker_checker srammc2plb4_0_regs_default[] = {
    ...
    //{"CID",         REGPOKER_READ_DCR, SRAMMC2PLB4_CID,        SRAMMC2PLB4_CID_DFLT,         SRAMMC2PLB4_CID_MASK     }, //RO
    //{"REVID",       REGPOKER_READ_DCR, SRAMMC2PLB4_REVID,      SRAMMC2PLB4_REVID_DFLT,       SRAMMC2PLB4_REVID_MASK   }, //RO
...
static const struct regpoker_checker aximcif2_regs_default[] = {
    //      name                check type          offset         exp val                  mask
    //{"AXIMCIF2_BESR_read",      REGPOKER_READ_DCR, AXIMCIF2_BESR_read,      AXIMCIF2_BESR_DFLT,       AXIMCIF2_BESR_MSK         }, // RO
    //{"AXIMCIF2_AEARL",          REGPOKER_READ_DCR, AXIMCIF2_AEARL,          AXIMCIF2_AEARL_DFLT,      AXIMCIF2_AEARL_MSK        }, // RO
    //{"AXIMCIF2_AEARU",          REGPOKER_READ_DCR, AXIMCIF2_AEARU,          AXIMCIF2_AEARU_DFLT,      AXIMCIF2_AEARU_MSK        }, // RO
    //{"AXIMCIF2_ERRID",          REGPOKER_READ_DCR, AXIMCIF2_ERRID,          AXIMCIF2_ERRID_DFLT,      AXIMCIF2_ERRID_MSK        }, // RO
    ...
    //{"AXIMCIF2_AXISTS",         REGPOKER_READ_DCR, AXIMCIF2_AXISTS,         AXIMCIF2_AXISTS_DFLT,     AXIMCIF2_AXISTS_MSK       }, // RO
    ...
    //{"AXIMCIF2_AXIRID",         REGPOKER_READ_DCR, AXIMCIF2_RID,            AXIMCIF2_RID_DFLT,        AXIMCIF2_RID_MSK          }, // RO
...
static const struct regpoker_checker plb6mcif2_regs_default[] = {
    //      name                check type          offset         exp val                  mask
    //{"PLB6MCIF2_BEARL",     REGPOKER_READ_DCR, PLB6MCIF2_BEARL,     0x00,                0xffffffff   }, // RO
    //{"PLB6MCIF2_BEARU",     REGPOKER_READ_DCR, PLB6MCIF2_BEARU,     0x00,                0xffffffff   }, // RO
    ...
    //{"PLB6MCIF2_SR0CF",     REGPOKER_READ_DCR, PLB6MCIF2_SR0CF,     0x00,                0xffffffff   }, // RO
    //{"PLB6MCIF2_SR1CF",     REGPOKER_READ_DCR, PLB6MCIF2_SR1CF,     0x00,                0xffffffff   }, // RO
    //{"PLB6MCIF2_SR2CF",     REGPOKER_READ_DCR, PLB6MCIF2_SR2CF,     0x00,                0xffffffff   }, // RO
    //{"PLB6MCIF2_SR3CF",     REGPOKER_READ_DCR, PLB6MCIF2_SR3CF,     0x00,                0xffffffff   }, // RO
    //{"PLB6MCIF2_STATUS",    REGPOKER_READ_DCR, PLB6MCIF2_STATUS,    0x80000000,          0xffffffff   }, // RO
    {/* Sentinel */}};
...
static const struct regpoker_checker mclfir_regs_default[] = {
    //      name                       check type          offset                     exp val     mask
    //{"MCLFIR_MC_ERR0",               REGPOKER_READ_DCR, MCLFIR_MC_ERR0,               0x00,       0xffffffff   }, // RO
    //{"MCLFIR_MC_ERR1",               REGPOKER_READ_DCR, MCLFIR_MC_ERR1,               0x00,       0xffffffff   }, // RO
    //{"MCLFIR_MC_ERR_MSK0",           REGPOKER_READ_DCR, MCLFIR_MC_ERR_MSK0,           0xFFFFFFFF, 0xffffffff   }, // RO
    //{"MCLFIR_MC_ERR_MSK1",           REGPOKER_READ_DCR, MCLFIR_MC_ERR_MSK1,           0xFFFFFFC0, 0xffffffff   }, // RO
    ...
    //{"MCLFIR_MC_LFIR",               REGPOKER_READ_DCR, MCLFIR_MC_LFIR,               0x00,       0xffffffff   }, // RO
    //{"MCLFIR_MC_LFIR_MSK",           REGPOKER_READ_DCR, MCLFIR_MC_LFIR_MSK,           0xC0000000, 0xffffffff   }, // RO
    //{"MCLFIR_MC_CONSOL_STAT",        REGPOKER_READ_DCR, MCLFIR_MC_CONSOL_STAT,        0x00f00000, 0xffffffff   }, // RO
    //{"MCLFIR_MC_CONSOL_STAT_TRIG",   REGPOKER_READ_DCR, MCLFIR_MC_CONSOL_STAT_TRIG,   0x00,       0xffffffff   }, // RO
    //{"MCLFIR_MC_CONSOL_STAT_MSK",    REGPOKER_READ_DCR, MCLFIR_MC_CONSOL_STAT_MSK,    0xFFF08000, 0xffffffff   }, // RO
    //{"MCLFIR_MC_CONSOL_STATSUM",     REGPOKER_READ_DCR, MCLFIR_MC_CONSOL_STATSUM,     0x00,       0xffffffff   }, // RO
    //{"MCLFIR_MC_CONSOL_STATSUM_MSK", REGPOKER_READ_DCR, MCLFIR_MC_CONSOL_STATSUM_MSK, 0x80000000, 0xffffffff   }, // RO
    {}};
...
struct regpoker_checker sp804_checker[] = {
    ...
    //{"DIT0_REG_VALUE0",   REGPOKER_READ_DCR, DIT0_REG_VALUE0,   DIT0_REG_VALUE0_DFLT,   DIT0_REG_VALUE0_mask     }, // RO
    {"DIT0_REG_CONTROL0", REGPOKER_READ_DCR, DIT0_REG_CONTROL0, DIT0_REG_CONTROL0_DFLT, DIT0_REG_CONTROL0_mask   },
    //{"DIT0_REG_RIS0",     REGPOKER_READ_DCR, DIT0_REG_RIS0,     DIT0_REG_RIS0_DFLT,     DIT0_REG_RIS0_mask       }, // RO
    //{"DIT0_REG_MIS0",     REGPOKER_READ_DCR, DIT0_REG_MIS0,     DIT0_REG_MIS0_DFLT,     DIT0_REG_MIS0_mask       }, // RO
    ...
    //{"DIT0_REG_VALUE1",   REGPOKER_READ_DCR, DIT0_REG_VALUE1,   DIT0_REG_VALUE1_DFLT,   DIT0_REG_VALUE1_mask     }, // RO
    {"DIT0_REG_CONTROL1", REGPOKER_READ_DCR, DIT0_REG_CONTROL1, DIT0_REG_CONTROL1_DFLT, DIT0_REG_CONTROL1_mask   },
    //{"DIT0_REG_RIS1",     REGPOKER_READ_DCR, DIT0_REG_RIS1,     DIT0_REG_RIS1_DFLT,     DIT0_REG_RIS1_mask       }, // RO
    //{"DIT0_REG_MIS1",     REGPOKER_READ_DCR, DIT0_REG_MIS1,     DIT0_REG_MIS1_DFLT,     DIT0_REG_MIS1_mask       }, // RO
...
struct regpoker_checker sp804_checker_rw[] = {
    ...
    //{"Timer1Value",  REGPOKER_READ_DCR,  DIT0_REG_VALUE0,  0x00000000, 0xffffffff   }, // RO
    //{"Timer1RIS",    REGPOKER_READ_DCR,  DIT0_REG_RIS0,    0b0,        0b1          }, // RO
    //{"Timer1MIS",    REGPOKER_READ_DCR,  DIT0_REG_MIS0,    0b0,        0b1          }, // RO
    ...
    //{"Timer2Value",  REGPOKER_READ_DCR,  DIT0_REG_VALUE1,  0x00000000, 0x00000000   }, // RO
    //{"Timer2RIS",    REGPOKER_READ_DCR,  DIT0_REG_RIS1,    0b0,        0b1          }, // RO
    //{"Timer2MIS",    REGPOKER_READ_DCR,  DIT0_REG_MIS1,    0b0,        0b1          }, // RO
...
static struct rumboot_pokerlist the_big_list[] = {
    ...
    //{wdt_checker,                DCR_WATCHDOG_BASE}, // RO
    ...
    //{nic_checker,                AXI32HSIFS_CTRL_BASE}, // RO
    //{nic_checker,                AXI64HSIFS_CTRL_BASE}, // RO
