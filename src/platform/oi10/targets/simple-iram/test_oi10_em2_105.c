...
int main ()
{
    ...
    nor_write32 ( 0x00000000, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x20 );
    nor_write32 ( 0x10101010, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x1C );
    nor_write32 ( 0x11111111, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x18 );
    nor_write32 ( 0xBABADEDA, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x14 );
    nor_write32 ( 0xDEDABABA, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x10 );
    nor_write32 ( 0xAAAAAAAA, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x0C );
    nor_write32 ( 0x55555555, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x08 );
    nor_write32 ( 0xCCCCCCCC, NOR_BASE+NOR_SIZE-ROM_IN_NOR_SIZE-0x04 );
