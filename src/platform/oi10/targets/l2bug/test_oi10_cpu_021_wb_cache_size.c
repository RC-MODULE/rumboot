...
//       MMU_TLB_ENTRY(  ERPN,   RPN,        EPN,        DSIZ,                   IL1I,  IL1D,   W,      I,      M,      G,      E,                      UX, UW, UR,     SX, SW, SR      DULXE,  IULXE,      TS,     TID,                WAY,                BID,                V   )
        ...
        /* code l1i cacheable page */
        {MMU_TLB_ENTRY(  0x000,  0x00000,    0x00000,    MMU_TLBE_DSIZ_64KB,     0b0,   0b1,    0b1,    0b0,    0b1,    0b0,    MMU_TLBE_E_BIG_END,     0b0,0b0,0b0,    0b1,0b1,0b1,    0b0,    0b0,        0b0,    MEM_WINDOW_0,       MMU_TLBWE_WAY_3,    MMU_TLBWE_BE_UND,   0b1 )},
        {MMU_TLB_ENTRY(  0x000,  0x00010,    0x00010,    MMU_TLBE_DSIZ_64KB,     0b0,   0b1,    0b1,    0b0,    0b1,    0b0,    MMU_TLBE_E_BIG_END,     0b0,0b0,0b0,    0b1,0b1,0b1,    0b0,    0b0,        0b0,    MEM_WINDOW_0,       MMU_TLBWE_WAY_3,    MMU_TLBWE_BE_UND,   0b1 )},
        {MMU_TLB_ENTRY(  0x000,  0x00020,    0x00020,    MMU_TLBE_DSIZ_64KB,     0b0,   0b1,    0b1,    0b0,    0b1,    0b0,    MMU_TLBE_E_BIG_END,     0b0,0b0,0b0,    0b1,0b1,0b1,    0b0,    0b0,        0b0,    MEM_WINDOW_0,       MMU_TLBWE_WAY_3,    MMU_TLBWE_BE_UND,   0b1 )},
        {MMU_TLB_ENTRY(  0x000,  0x00030,    0x00030,    MMU_TLBE_DSIZ_64KB,     0b0,   0b1,    0b1,    0b0,    0b1,    0b0,    MMU_TLBE_E_BIG_END,     0b0,0b0,0b0,    0b1,0b1,0b1,    0b0,    0b0,        0b0,    MEM_WINDOW_0,       MMU_TLBWE_WAY_3,    MMU_TLBWE_BE_UND,   0b1 )},
...
// did, 19.12.19, SPR_CCR2, DSTG - CCR2[0:1]
    spr_write(SPR_CCR2, spr_read(SPR_CCR2) | 0xC0000000 );
// STGCTR CCR2[12:15]
   spr_write(SPR_CCR2, spr_read(SPR_CCR2) | 0x000F0000 );
// Disable gathering
   dcr_write(0x80000600, 0xC10); // L2WACCFG
   dcr_write(0x80000604, 0x1);   // 0x1   

    rumboot_printf( "Cache test code (in L1I)\n" );
    for( uint32_t l1i_addr = SRAM0_BASE; l1i_addr < (SRAM0_BASE+L1I_SIZE); l1i_addr += L1C_LINE_SIZE ) {
        icbt(0, l1i_addr);
    }
    msync();
    ...
    rumboot_printf( "8a. Read and check cacheable memory 1, size = 0x%x @ 0x%x (pattern 1)\n", l2c_check_size, CACHEABLE_ADDR1);
    if( !read_and_check( CACHEABLE_ADDR1, l2c_check_size, PTRN_INC_1, true ) ) return false;
