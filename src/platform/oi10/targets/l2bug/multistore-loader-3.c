...
void read_all_l1_cache(){
    rumboot_printf("******** Read ALL etries of L1D *********\n");
    read_l1_cache(0,0,0,3,255,7,0);
    }
void read_valid_l1_cache(){
    rumboot_printf("******** Read ALL VALID etries of L1D *********\n");
