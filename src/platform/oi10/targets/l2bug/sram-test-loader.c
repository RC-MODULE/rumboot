...
int main( void )
{
    ...
    printf( "Memset\n" );
    memset( ( void * )0x0,     0, 0x80 );   // .header
    memset( ( void * )0x00400, 0, 0x1000 );  // .text
    memset( ( void * )0x08a00, 0, 0x200 );  // .memcpy_copyed
    memset( ( void * )0x08c00, 0, 0x400 );  // stack
    memset( ( void * )0x20b00, 0, 0x200 );  // monitor_version[]
    memset( ( void * )0x21f00, 0, 0x500 );  // tx_buf[]
