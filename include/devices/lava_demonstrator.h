...
int load_demonstrator_data    (int heap_id, uintptr_t addr_src,  uint32_t data_size);
int load_demonstrator_weights (int heap_id, uintptr_t addr_src,  uint32_t data_size);
int load_demonstrator_result  (int heap_id, uintptr_t addr_src,  uint32_t data_size);
int run_matrix();
