...
// Valid settings range from 4 (‘0100’) to 8 (‘1000’), and are set during synthesis.
...
//DECLARE_ENUM_VAL( BOOST_PP_CAT( PLB6BC_TSNOOP_, BOOST_PP_ADD(4,n) ), 0b0100 + n )
...
// Valid settings range from 1 - 3 (‘01’ - ‘11’) to represent 1 - 3 clock cycles respectively. If an invalid number is input, it defaults to three clocks.
