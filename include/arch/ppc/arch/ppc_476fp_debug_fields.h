...
#define DEBUG_DBSR_MRR_mask     FIELD_MASK32(DEBUG_DBSR_MRR_i, DEBUG_DBSR_MRR_n)

BEGIN_ENUM(DEBUG_DBSR_MRR_VALUES)
    DECLARE_ENUM_VAL(   DEBUG_DBSR_MRR_VALUES_NO_RESET,         0)
    DECLARE_ENUM_VAL(   DEBUG_DBSR_MRR_VALUES_CORE_RESET,       1)
    DECLARE_ENUM_VAL(   DEBUG_DBSR_MRR_VALUES_CHIP_RESET,       2)
    DECLARE_ENUM_VAL(   DEBUG_DBSR_MRR_VALUES_SYSTEM_RESET,     3)
END_ENUM(DEBUG_DBSR_MRR_VALUES)
