...
DECLARE_ENUM_VAL(    P64CR_SPEN      ,   IBM_BIT_INDEX(32, 23))
DECLARE_ENUM_VAL(    P64CR_OWEN      ,   IBM_BIT_INDEX(32, 22))
DECLARE_ENUM_VAL(    P64CR_IPC       ,   IBM_BIT_INDEX(32, 21))
DECLARE_ENUM_VAL(    P64CR_IFMID0    ,   IBM_BIT_INDEX(32, 15))
DECLARE_ENUM_VAL(    P64CR_IFMID1    ,   IBM_BIT_INDEX(32, 10))
DECLARE_ENUM_VAL(    P64CR_IFE0      ,   IBM_BIT_INDEX(32,  5))
DECLARE_ENUM_VAL(    P64CR_IFE1      ,   IBM_BIT_INDEX(32,  4))
END_ENUM( P64_P64CR_FIELD)

DECLARE_CONST( P64CR_PRI_MASK,      0b11)
DECLARE_CONST( P64CR_SPEN_MASK,     0b1)
DECLARE_CONST( P64CR_OWEN_MASK,     0b1)
DECLARE_CONST( P64CR_IPC_MASK,      0b1)
DECLARE_CONST( P64CR_IFMIDi_MASK,   0x1F)
DECLARE_CONST( P64CR_IFEi_MASK,     0b1)

BEGIN_ENUM( P64CR_PRI_N )
DECLARE_ENUM_VAL(     P64CR_PRI_0    ,   0b00)
DECLARE_ENUM_VAL(     P64CR_PRI_1    ,   0b01)
DECLARE_ENUM_VAL(     P64CR_PRI_2    ,   0b10)
DECLARE_ENUM_VAL(     P64CR_PRI_3    ,   0b11)
END_ENUM( P64CR_PRI_N )
