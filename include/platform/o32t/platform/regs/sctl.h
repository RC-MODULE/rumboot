...
BEGIN_ENUM( SCTL_REG )
    ...
    DECLARE_ENUM_VAL(   KMBIST_CHAIN_SF_9,      0x028 )
    DECLARE_ENUM_VAL(   KMBIST_CHAIN_SF_10,     0x02C )
    DECLARE_ENUM_VAL(   KMBIST_CHAIN_SF_11,     0x030 )
    DECLARE_ENUM_VAL(   SCTL_PPC_SYS_CONF,      0x034 )
    DECLARE_ENUM_VAL(   SCTL_PPC_SLP_CTRL,      0x038 )
    DECLARE_ENUM_VAL(   SCTL_PPC_PMU_CTRL,      0x03C )
    DECLARE_ENUM_VAL(   SCTL_IFSYS_ETH_HPROT,   0x040 )
    DECLARE_ENUM_VAL(   SCTL_NMPU_PRST,         0x044 )
    DECLARE_ENUM_VAL(   SCTL_NMPU_DBG_PRST,     0x048 )
    DECLARE_ENUM_VAL(   SCTL_NMPU_NMI,          0x04C )
END_ENUM( SCTL_REG )
