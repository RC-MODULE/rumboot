...
#        include <platform/oi10/platform/boost/preprocessor/iteration/detail/start.hpp>
#        define BOOST_PP_VALUE BOOST_PP_TUPLE_ELEM(2, 1, BOOST_PP_LOCAL_LIMITS)
#        include <platform/oi10/platform/boost/preprocessor/iteration/detail/finish.hpp>
...
#    include <platform/oi10/platform/boost/preprocessor/iteration/detail/rlocal.hpp>
# else
