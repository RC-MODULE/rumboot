...
#define                 MPIC128_VP(x)		(0x00010000 + (0x0020*(x))) // MPIC Vector/Priority Register
...
#define					MPIC128_DST(x)		(0x00010010 + (0x0020*(x))) // MPIC Destination Register
...
#define                         MPIC128_IPID(x)    (0x00020040 + (0x1010*(x))) // MPIC Inter processor Interrupt Dispatch
...
DECLARE_ENUM_VAL(               MPIC128_CTP_PR,    0x00000080 )                // Current Task Priority Register
...
DECLARE_ENUM_VAL(               MPIC128_WAI_PR,    0x00000090 )                // Who Am I Register
...
DECLARE_ENUM_VAL(               MPIC128_NCIAR_PR,  0x000000A0 )                // Non Critical Interrupt Acknowledge Register
...
DECLARE_ENUM_VAL(               MPIC128_NCEOI_PR,  0x000000B0 )                // Non Critical End of Interrupt Register
...
DECLARE_ENUM_VAL(               MPIC128_CIAR_PR,   0x000000C0 )                // Critical Interrupt Acknowledge Register
...
DECLARE_ENUM_VAL(               MPIC128_CEOI_PR,   0x000000D0 )                // Critical End of Interrupt Register
...
DECLARE_ENUM_VAL(               MPIC128_IAR_PR,    0x000000E0 )                // Machine Check Interrupt Acknowledge Register
...
DECLARE_ENUM_VAL(               MPIC128_EOI_PR,    0x000000F0 )                // Machine Check End of Interrupt Register
...
#define                         MPIC128_IVP(x)     (0x000010A0 + (0x0010*(x))) // IPI Vector/Priority Register
...
#define                         MPIC128_TCC(x)     (0x00001100 + (0x0040*(x))) // Timer Current Count Register
...
#define                         MPIC128_TBC(x)     (0x00001110 + (0x0040*(x))) // Timer Base Count Register
...
#define                         MPIC128_TVP(x)     (0x00001120 + (0x0040*(x))) // Timer Vector/Priority Register
...
#define                         MPIC128_TDST(x)    (0x00001130 + (0x0040*(x))) // Timer n Destination Register
