...
BEGIN_ENUM( MSP_REG )
    ...
    DECLARE_ENUM_VAL( MSP_CSP,              0x03 )
    DECLARE_ENUM_VAL( MSP_SRR,              0x03 )
    DECLARE_ENUM_VAL( MSP_BC_CW,            0X04 )
    DECLARE_ENUM_VAL( MSP_RT_CW,            0X04 )
    ...
    DECLARE_ENUM_VAL( MSP_BCFT,             0x0D )
    DECLARE_ENUM_VAL( MSP_RTLC,             0x0D )
    DECLARE_ENUM_VAL( MSP_MTTW,             0x0D )
    DECLARE_ENUM_VAL( MSP_BCFT_RTLC_MTTW,   0x0D ) /* from doc */
