 ...
 *
 *  \details Config work mode - SCRB_CR[2]
 */
 ...
 *
 *  \details Start scrubber - SCRB_CR[1] start for im2, SCRB_CR[0] - for im1
 */
 ...
 *
 *  \param [in] base_addr Set base addr from test, cuz you cant get it from lib for some reason
 *  \details Get number of errors at im1 at the end of scrubbing, reg FCNT[15:0]
 */
 ...
 *
 *  \param [in] base_addr Set base addr from test, cuz you cant get it from lib for some reason
 *  \details Get number of errors at im2 at the end of scrubbing, reg FCNT[31:16]
 */
