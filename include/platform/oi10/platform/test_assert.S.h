...
.macro test_assert suffix, crfield, file, line, text, tmp_reg=r5, tmp_reg_msr=r6, crAccErr=cr6 errLabel=test_error
...
#define _TEST_ASSERT(condition, crfield, text, tmp_reg, tmp_reg_msr) \
    test_assert condition, crfield, __FILE__, __LINE__, text, tmp_reg, tmp_reg_msr
