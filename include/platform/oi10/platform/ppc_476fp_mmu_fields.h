...
//DECLARE_ENUM_VAL( BOOST_PP_CAT(BOOST_PP_CAT( MMU_SSPCR_ORD,n),_e ), (MMU_SSPCR_ORDn_n*n) - 1 )
//#define BOOST_PP_LOCAL_LIMITS (1, MMU_XSPCR_ORD_N)
//#include BOOST_PP_LOCAL_ITERATE()
//#define BOOST_PP_LOCAL_MACRO( n )\
//DECLARE_ENUM_VAL( BOOST_PP_CAT(BOOST_PP_CAT( MMU_SSPCR_ORD,n),_i ), IBM_BIT_INDEX( 32, BOOST_PP_CAT(BOOST_PP_CAT( MMU_SSPCR_ORD,n),_e ) ) )
//#define BOOST_PP_LOCAL_LIMITS (1, MMU_XSPCR_ORD_N)
//#include BOOST_PP_LOCAL_ITERATE()
...
//#define BOOST_PP_LOCAL_MACRO( n )\
//DECLARE_ENUM_VAL( BOOST_PP_CAT(BOOST_PP_CAT( MMU_ISPCR_ORD,n),_e ), ((MMU_ISPCR_ORDn_n+1) * n) - 1 )
//#define BOOST_PP_LOCAL_LIMITS (1, MMU_XSPCR_ORD_N)
//#include BOOST_PP_LOCAL_ITERATE()
//#define BOOST_PP_LOCAL_MACRO( n )\
//DECLARE_ENUM_VAL( BOOST_PP_CAT(BOOST_PP_CAT( MMU_ISPCR_ORD,n),_i ), IBM_BIT_INDEX( 32, BOOST_PP_CAT(BOOST_PP_CAT( MMU_ISPCR_ORD,n),_e ) ) )
//#define BOOST_PP_LOCAL_LIMITS (1, MMU_XSPCR_ORD_N)
//#include BOOST_PP_LOCAL_ITERATE()
...
//#define BOOST_PP_LOCAL_MACRO( n )\
//DECLARE_ENUM_VAL( BOOST_PP_CAT(BOOST_PP_CAT( MMU_USPCR_ORD,n),_e ), (MMU_USPCR_ORDn_n*n) - 1 )
//#define BOOST_PP_LOCAL_LIMITS (1, MMU_XSPCR_ORD_N)
//#include BOOST_PP_LOCAL_ITERATE()
//#define BOOST_PP_LOCAL_MACRO( n )\
//DECLARE_ENUM_VAL( BOOST_PP_CAT(BOOST_PP_CAT( MMU_USPCR_ORD,n),_i ), IBM_BIT_INDEX( 32, BOOST_PP_CAT(BOOST_PP_CAT( MMU_USPCR_ORD,n),_e ) ) )
//#define BOOST_PP_LOCAL_LIMITS (1, MMU_XSPCR_ORD_N)
//#include BOOST_PP_LOCAL_ITERATE()
