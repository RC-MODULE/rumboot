...
BEGIN_ENUM( HSCB_RWDMA_SETTINGS_FIELD )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_DESC_INT_i,            0 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_DESC_INT_n,            1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_DESC_INT_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_DESC_INT_i, HSCB_RWDMA_SETTINGS_DESC_INT_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_DESC_END_i,            1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_DESC_END_n,            1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_DESC_END_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_DESC_END_i, HSCB_RWDMA_SETTINGS_DESC_END_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_BAD_DESC_i,            2 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_BAD_DESC_n,            1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_BAD_DESC_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_BAD_DESC_i, HSCB_RWDMA_SETTINGS_BAD_DESC_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_AXI_ERROR_i,        5 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_AXI_ERROR_n,        1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_AXI_ERROR_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_RW_AXI_ERROR_i, HSCB_RWDMA_SETTINGS_RW_AXI_ERROR_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_BUF_FULL_i,         6 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_BUF_FULL_n,         1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_BUF_FULL_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_RW_BUF_FULL_i, HSCB_RWDMA_SETTINGS_RW_BUF_FULL_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_BUF_EMPTY_i,        7 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_BUF_EMPTY_n,        1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RW_BUF_EMPTY_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_RW_BUF_EMPTY_i, HSCB_RWDMA_SETTINGS_RW_BUF_EMPTY_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_EN_RWDMA_i,           28 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_EN_RWDMA_n,            1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_EN_RWDMA_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_EN_RWDMA_i, HSCB_RWDMA_SETTINGS_EN_RWDMA_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_EN_RWDMA_DESC_TBL_i,  29 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_EN_RWDMA_DESC_TBL_n,   1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_EN_RWDMA_DESC_TBL_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_EN_RWDMA_DESC_TBL_i, HSCB_RWDMA_SETTINGS_EN_RWDMA_DESC_TBL_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RWDMA_LONG_LEN_i,     30 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RWDMA_LONG_LEN_n,      1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_RWDMA_LONG_LEN_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_RWDMA_LONG_LEN_i, HSCB_RWDMA_SETTINGS_RWDMA_LONG_LEN_n ) )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_CANCEL_RWDMA_i,      31 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_CANCEL_RWDMA_n,       1 )
    DECLARE_ENUM_VAL(    HSCB_RWDMA_SETTINGS_CANCEL_RWDMA_mask, FIELD_MASK32( HSCB_RWDMA_SETTINGS_CANCEL_RWDMA_i, HSCB_RWDMA_SETTINGS_CANCEL_RWDMA_n ) )
END_ENUM( HSCB_RWDMA_SETTINGS_FIELD )
